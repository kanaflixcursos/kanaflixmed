...
- A rota `/` deixou de exibir dados demonstrativos e sempre abre `/login`; autenticação concluída segue diretamente para `/agenda`, enquanto cadastro novo segue para `/onboarding`.
