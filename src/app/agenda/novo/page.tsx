...
export default async function NewAppointmentPage({ searchParams }: { searchParams: Promise<{ data?: string; hora?: string; returnTo?: string }> }) {
  ...
  return <NewAppointmentForm initialDate={date} initialTime={time} returnTo={returnTo} />;
}
